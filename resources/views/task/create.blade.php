                    ...
                    @if (count($clients) == 0)
                        <div class="bg-orange-500 text-white text-center p-3">
                            <p>You don't have any client <a href="{{ route('client.create') }}"
                                    class="bg-black text-white px-3 text-sm rounded-md ml-1 py-2">Add New Client</a></p>
                            <p class="mt-2">You have define client first!</p>
                        </div>
                    @endif
                        ...
                        <div class="mt-6 flex">
                            ...
                            <div class="flex-1 ml-2">
                                ...
                                <input type="date" class="formInput" name="start_date" id="start_date"
                                    min="2022-09-08" value="{{ now()->format('d-m-Y') }}"
