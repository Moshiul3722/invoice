                            ...
                            <div class="flex-1 ml-8 flex flex-col justify-between">
                                <div class="flex mt-6 justify-between">
                                    ...
                                    <div class="border p-2">
                                        @if (Auth::user()->thumbnail)
                                            <img src="{{ getImageUrl(Auth::user()->thumbnail) }}"
                                                class="w-20" alt="">
                                        @else
                                            <img src="https://via.placeholder.com/150" class="w-20" alt="">
                                        @endif
                                ...
                                <div class="flex justify-between">
                                    ...
                                    <div class="border p-2">
                                        ...
                                        @if (file_exists('storage/uploads/invoice_logo.png'))
                                            <img src="{{ asset('storage/uploads/invoice_logo.png') }}"
                                                class="w-20" alt="">
                                        @else
