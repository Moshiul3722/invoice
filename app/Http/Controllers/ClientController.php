...
class ClientController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        //SaveMethod-01: Data save by creating object instance
        ...
        //SaveMethod-02: Data save by Eloquent model
    ...
    public function show(Client $client)
    {
        ...
        return view('client.profile')->with([
            ...
            'paid' => $client->tasks->where('status', 'paid')
        ]);
    }
    ...
    public function destroy(Client $client)
    {
        ...
        $task = $client->tasks->where('status', 'pending');
        ...
        if (count($task) == 0) {
            ...
            return redirect()->route('client.index')->with('success', 'Client has' . count($task) . ' pending task');
        }
